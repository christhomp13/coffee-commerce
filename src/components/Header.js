        ...
        <header className='sticky top-0 z-50'>
            <div className='flex items-center p-2 px-8 bg-gray-800 text-white'>
                <div className='hidden sm:flex items-center mt-2 space-x-10'>
                    <h1 className='hover:underline cursor-pointer'>Shop</h1>
                ...
                <div onClick={()=> history.push('/')} className='flex flex-grow justify-center items-center mx-auto'>
                    <h1 className='text-3xl font-bold cursor-pointer hover:bg-white hover:text-gray-800 p-2 active:scale-90 transition duration-150'>Best Coffee Co.</h1>
                </div>

                <div className='relative flex items-center space-x-5'>
                    <h1 className='hover:underline cursor-pointer'>Subscribe</h1>
